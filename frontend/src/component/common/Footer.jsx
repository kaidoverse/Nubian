...
const Footer = () => {
    return (
        <footer className='border-t py-12'>
            <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 '>
                ...
                <div>
                    ...
                    <div className='flex items-center space-x-4 mb-6'>
                        <a href="https.//www.facebook.com" target='blank' rel='noopener noreferrer' className='hover:text-gray-300'>
                ...
                <div>
                    ...
                    <p className='text-gray-500 mb-4'>
                        Be the first to hear about our new products, exclusive events, and online offers.
                    </p>
            ...
            {/* footer bottom */}
            <div className='container mx-auto mt-12 px-4 lg:px-0 border-t bordercolorgray-200 pt-6'>
                <p className='text-gray-500 text-sm tracking-tighter text-center
                '>
                    &copy; {new Date().getFullYear()} NUBIAN. All rights reserved.
