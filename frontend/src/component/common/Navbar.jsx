...
const Navbar = () => {
    ...
    const [navDrawerOpen, setNavDraweOpen] = useState(false)

    const toggleNavDrawer = () => {
        setNavDraweOpen(!navDrawerOpen);
    }
    ...
    return (
        <>
            <nav className="container mx-auto flex items-center justify-between py-4 px-6">
                {/* Left-Logo */}
                <div>
                    <Link to="/" className="text-2xl font-inter font-medium font-bold">Nubian</Link>
                </div>
                {/*center- Nav-links*/}
